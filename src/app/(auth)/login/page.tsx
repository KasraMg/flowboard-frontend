...
export default function LoginPage() {
  ...
  const [email, setEmail] = React.useState('alex.morgan@flowboard.app');
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="pl-9 pr-9"
        ...
        <Button type="submit" className="w-full" disabled={loading}>
          {loading ? <span className="flex items-center gap-2"><span className="h-4 w-4 animate-spin rounded-full border-2 border-primary-foreground border-t-transparent" /> Signing in...</span> : 'Sign in'}
        </Button>
      </form>
      ...
      <Button variant="outline" className="w-full" onClick={() => { login(email); router.push('/dashboard'); }}>
